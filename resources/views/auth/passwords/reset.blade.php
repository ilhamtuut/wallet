        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form method="POST" action="{{ route('password.update') }}">
                    ...
                    <div class="form-group row">
                        <label for="password" class="col-md-4 col-form-label mt-5 text-right">{{ __('Password') }}</label>
                    ...
                    <div class="form-group row">
                        <label for="password-confirm" class="col-md-4 col-form-label mt-5 text-right">{{ __('Confirm Password') }}</label>
