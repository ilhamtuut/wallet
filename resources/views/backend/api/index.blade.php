    ...
    <div class="col-md-12">
        <div class="panel panel-primary">
            <div class="panel-body">
                <h1><b class="text-white">Let's get your project started!</b></h1>
...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <div class="panel panel-primary bg-item">
            ...
            <div class="panel-footer">                                 
                <button class="btn btn-primary btn-block">Read Documentation</button>
            </div>
        </div>
